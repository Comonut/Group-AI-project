...
public class MidiHandler extends VirtualPiano {
	...
	public MidiHandler(/*DBController db*/) throws FileNotFoundException {
		System.out.println(
	...
	public class MidiInputReceiver implements Receiver {
		...
		public void send(MidiMessage msg, long timeStamp) {
			...
			final String[] NOTE_NAMES = { "Do", "Do_Sharp", "Re", "Re_Sharp", "Mi", "Fa", "Fa_Sharp", "Sol",
					"Sol_Sharp", "La", "La_Sharp", "Si" };
