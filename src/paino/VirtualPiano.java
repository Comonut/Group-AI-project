...
public class VirtualPiano extends JFrame {
    ...
    public VirtualPiano() {
        ...
        SettingsPanel.setBounds(242, 6, 866, 424);
        ...
        txtInsertANumber.setText("Insert an integer greater than 0 ");
        ...
        textField_1.setText("Insert a number greater or equal to 2");
        ...
        adminPanel.setBounds(468, 6, 597, 319);
        ...
        btnKeyboardImage.setBounds(0, 38, 507, 148);
        ...
        browsePanel.setBounds(10, 6, 456, 359);
        mainPanel.add(browsePanel);
        browsePanel.setVisible(false);
        browsePanel.setEnabled(false);
        
        JTable tblMusic = new JTable();
        Object[] col = {"Player ID", "Name", "Date Of Creation", "Mode"};
        JScrollPane scroll = new JScrollPane(tblMusic); //<---
        scroll.setBounds(190, 15, 389, 230);
        model2 = (DefaultTableModel) tblMusic.getModel();
        model2.setColumnIdentifiers(col);
        browsePanel.add(scroll); 
        ...
        btnExport.setBounds(10, 141, 95, 43);
        adminPanel.add(btnExport);
        
        JButton btnDeleteMusic = new JButton("Delete Music");
        btnDeleteMusic.setBounds(10, 199, 95, 43);
        adminPanel.add(btnDeleteMusic);
        
        btnDeleteMusic.setEnabled(false);
		btnDeleteMusic.setVisible(false);
		btnExport.setEnabled(false);
		btnExport.setVisible(false);
		
        JButton btnBrowseMusic = new JButton("Browse Music");
        btnBrowseMusic.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		browsePanel.setEnabled(true);
        		browsePanel.setVisible(true);
        		btnDeleteMusic.setEnabled(true);
        		btnDeleteMusic.setVisible(true);
        		btnExport.setEnabled(true);
        		btnExport.setVisible(true);
        	}
        });
        btnBrowseMusic.setBounds(10, 256, 95, 43);
        ...
        save = new ImageIcon("image/Save_IMG.png");
        saveImg = save.getImage();
        Image newSaveImg = saveImg.getScaledInstance(btnSaveTrack.getWidth(), btnSaveTrack.getHeight(), java.awt.Image.SCALE_SMOOTH);
        save = new ImageIcon(newSaveImg);
